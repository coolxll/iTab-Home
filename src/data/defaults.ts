...
export const DEFAULT_SHORTCUTS_TOP: Shortcut[] = [
  ...
  { id: 'doubao', title: '豆包-你的AI朋友', url: 'https://www.doubao.com', icon: 'doubao', bgColor: 'bg-sky-400' },
...
export const DEFAULT_SHORTCUTS_DOCK1: Shortcut[] = [
  ...
  { id: 'aistudio', title: 'Google AI Studio', url: 'https://aistudio.google.com', icon: 'aistudio', bgColor: 'bg-black' },
  { id: 'gmail', title: 'Gmail', url: 'https://mail.google.com', icon: 'gmail', bgColor: 'bg-white' },
  { id: 'yuanbao', title: '腾讯元宝 - 轻...', url: 'https://yuanbao.tencent.com', icon: 'yuanbao', bgColor: 'bg-[#00C853]' },
  ...
  { id: 'nga', title: 'NGA玩家社区', url: 'https://bbs.nga.cn', icon: 'nga', bgColor: 'bg-[#3A220F]' },
]
...
export const DEFAULT_SHORTCUTS_DOCK2: Shortcut[] = [
  ...
  { id: 'homepage', title: 'Homepage', url: 'http://homepage.local', icon: 'homepage', bgColor: 'bg-[#3B82F6]' },
  { id: 'cloudflare', title: 'Cloudflare - ...', url: 'https://dash.cloudflare.com', icon: 'cloudflare', bgColor: 'bg-[#F38020]' },
  { id: 'rn-proxy', title: 'RN PROXY API', url: 'http://proxy.local', icon: 'rn-proxy', bgColor: 'bg-[#FF8800]' },
  { id: 'cpa-keeper', title: 'CPA Keeper', url: 'http://keeper.local', icon: 'cpa-keeper', bgColor: 'bg-[#FF9900]' },
  { id: 'cli-proxy', title: 'CLI Proxy API', url: 'http://cpa.local', icon: 'cli-proxy', bgColor: 'bg-[#E11D48]' },
  { id: 'cpa-usage', title: 'CPA USAGE ...', url: 'http://cpa-usage.local', icon: 'cpa-usage', bgColor: 'bg-[#EF4444]' },
  { id: 'codex-usage', title: 'Codex Usage', url: 'http://codex.local', icon: 'codex-usage', bgColor: 'bg-[#EA580C]' },
