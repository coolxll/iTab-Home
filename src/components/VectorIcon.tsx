...
export const VectorIcon: React.FC<VectorIconProps> = ({ name, variant = 'official' }) => {
  switch (name) {
    ...
    case 'bilibili':
      if (variant === 'official') {
        return (
          <div className="w-full h-full bg-[#FB7299] flex items-center justify-center text-white p-2 shadow-xs">
      ...
      return (
        <div className="w-full h-full bg-[#18181B] flex items-center justify-center text-[#FB7299] p-2">
